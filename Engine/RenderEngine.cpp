...
void RenderEngine::InitWindow()
{
	...
	// *************FULLSCREEN******************
	//window = glfwCreateWindow(1920, 1080, "Engine", glfwGetPrimaryMonitor(), NULL);
}
...
void RenderEngine::CreateDescriptorSetLayout()
{
	...
	VkDescriptorSetLayoutBinding samplyerLayoutBinding = {};
	samplyerLayoutBinding.binding = 1;
	samplyerLayoutBinding.descriptorCount = 1;
	samplyerLayoutBinding.descriptorType = VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER;
	samplyerLayoutBinding.pImmutableSamplers = nullptr;
	samplyerLayoutBinding.stageFlags = VK_SHADER_STAGE_FRAGMENT_BIT;

	std::array<VkDescriptorSetLayoutBinding, 2> bindings = { mvpLayoutBinding, samplyerLayoutBinding };
...
VkImageView RenderEngine::CreateImageView(VkImage image, VkFormat format, VkImageAspectFlags aspectFlags, uint32_t mipLevels)
{
...
void RenderEngine::CreateImage(uint32_t width, uint32_t height, uint32_t mipLevels, VkSampleCountFlagBits numSamples, VkFormat format, VkImageTiling tiling, VkImageUsageFlags usage, VkMemoryPropertyFlags properties, VkImage& image, VkDeviceMemory& imageMemory)
{
...
void RenderEngine::TransitionImageLayout(VkImage image, VkFormat format, VkImageLayout oldLayout, VkImageLayout newLayout, uint32_t mipLevels)
{
...
VkSampleCountFlagBits RenderEngine::GetMaxUsableSampleCount()
{
